...
#    install_tar_gz_package nginx nginx-1.4.4.tar.gz
#    install_tar_gz_package redis redis-2.8.1.tar.gz
#    install_tar_gz_package ctemplate ctemplate-2.2.tar.gz
#    install_tar_gz_package gflags gflags-2.0.tar.gz
    install_tar_gz_package glog glog-0.3.3.tar.gz
#    install_tar_gz_package protobuf protobuf-2.5.0.tar.bz2
#    install_tar_gz_package fcgi fcgi-2.4.0.tar.gz
#    install_tar_gz_package gperftools gperftools-2.1.tar.gz
