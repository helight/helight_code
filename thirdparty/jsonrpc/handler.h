...
public:
     ...
     */
    virtual bool Call(const json::Value& msg, json::Value& response, void *data) = 0;
...
public:
     ...
     */
    typedef bool (T::*Method)(const json::Value& msg, json::Value& response, void *data);
     ...
     */
    virtual bool Call(const json::Value& msg, json::Value& response, void *data)
    {
        return (m_obj->*m_method)(msg, response, data);
    }
...
public:
     ...
     */
    bool Process(const std::string& msg, json::Value& response, void *data);
     ...
     * and the return value is true.
     */
    bool Process(const char* msg, json::Value& response, void *data);
     ...
     */
    bool SystemDescribe(const json::Value& msg, json::Value& response, void *data);
...
private:
     ...
     * and the return value is true.
     */
    bool Process(const json::Value& root, json::Value& response, void *data);
};
